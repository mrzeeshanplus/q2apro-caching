...
Plugin Author: Vadim Kr. bndr + sama55 + stevenev + q2apro
...
qa_register_plugin_module('event', // type of module
 ...
 * Register the plugin
 */
qa_register_plugin_module('process', // type of module
...
qa_register_plugin_layer('qa-caching-layer.php', // PHP file containing module class
    'q2a Caching Plugin Layer');
qa_register_plugin_overrides('qa-caching-overrides.php' // PHP file containing overrided function
    );
